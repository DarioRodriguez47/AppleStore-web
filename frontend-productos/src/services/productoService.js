...
export const saveProducto = async () => {
  throw new Error("saveProducto no disponible en sitio estático");
};
export const updateProducto = async () => {
  throw new Error("updateProducto no disponible en sitio estático");
};
export const deleteProducto = async () => {
  throw new Error("deleteProducto no disponible en sitio estático");
};
export const uploadImage = async () => {
  throw new Error("uploadImage no disponible en sitio estático");
};
